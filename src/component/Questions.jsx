...
const Questions = (props) => {
  ...
  useEffect(() => {
    getQuestions('https://1b934091-9ec5-47d4-acf3-80dc04d90264.mock.pstmn.io/v1/questions')
            ...
            <AnswerConainer>
              {
                question.answers?.map((answer, index) =>
                  <div key={index}>
                    <input onChange={handleChange} type="radio" value={answer.type} name={question.question}/>
